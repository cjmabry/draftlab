...
dk_file.retrieve('https://www.draftkings.com/lineup/getavailableplayerscsv?contestTypeId=21&draftGroupId=7288','week3/mon_thu_DKSalaries.csv')

csvfile = open('week3/mon_thu_DKSalaries.csv', 'rb')
...
def insert_spread(data):
    ...
    vegas_file.retrieve('http://xml.pinnaclesports.com/pinnaclefeed.aspx?sporttype=Football&sportsubtype=nfl','week3/vegasodds.xml')
    tree = ElementTree.parse('week3/vegasodds.xml')
